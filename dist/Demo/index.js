...
ReactDOM.render(React.createElement(__1.default, { mapData: mapData, viewport: { width: 19, height: 15 }, controllableChar: { id: 'heroine', name: 'Heroine', image: charset1, x: 7, y: 3 }, chars: [
        { id: 'stranger-woman', name: 'Stranger', image: charset2, x: 9, y: 4, dir: __1.Direction.Up },
