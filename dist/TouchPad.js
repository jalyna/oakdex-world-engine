...
function default_1({ onMouseDown, onMouseUp }) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("button", { style: Object.assign({}, BUTTON_STYLE, { top: BUTTON_SIZE * 1, left: BUTTON_SIZE * 1 }), onContextMenu: (e) => e.preventDefault(), onTouchStart: onMouseDown.bind(this, 'Enter'), onTouchEnd: onMouseUp.bind(this, 'Enter') }, "\u25CE"))));
}
